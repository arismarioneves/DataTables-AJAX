...
## Dados do DataTable
/* Os valores do $_POST são armazenados em variáveis passadas pelo DataTable durante a solicitação AJAX: draw, start, length, order, columnIndex, column name, order, e search. */
$draw = $_POST['draw'];
$row = $_POST['start'];
